...
| 8 | Unit Test for Log string starting with timestamp regex positive | (1.) Load the sample string <br> (2.) Load the timestamp substring from the value <br> (3.) Assert that the timestamp regular expression is satisfied | The log string should successfuly be identified as starting wiht a timestamp | The log string should successfuly be identified as starting wiht a timestamp | Pass |
| 9 | Unit Test for Log string starting with timestamp regex negative | (1.) Load the sample string <br> (2.) Load the timestamp substring from the value <br> (3.) Assert that the timestamp regular expression is not satisfied | The log string should successfuly be identified as not starting wiht a timestamp | The log string should successfuly be identified as not starting wiht a timestamp | Pass |
| 10 | Unit Test for timestamp between time window positive | (1.) Load config file application.conf <br> (2.) Load the functionality configs <br> (3.) load value to check for <br>(4.) Assert that the timestamp value specified lies between the start and end time that we fetch from the funcconfig | The timestamp should be correctly identified as lying between our time window | The timestamp should be correctly identified as lying between our time window | Pass |
| 11 | Unit Test for timestamp between time window negative | (1.) Load config file application.conf <br> (2.) Load the functionality configs <br> (3.) load value to check for <br>(4.) Assert that the timestamp value specified does not lie between the start and end time that we fetch from the funcconfig | The timestamp should be correctly identified as lying outside our time window | The timestamp should be correctly identified as lying outside our time window | Pass |